...
public class XmlHandler {
    ...
    public static final String XML_PATH = System.getProperty("user.dir") + sep + "src" + sep
            + "main" + sep + "resources" + sep + "data" + sep + "profiles.xml";
    ...
    public static PlayerProfile elementToPlayer(Element player) {
        ...
        try {
            ...
            LocalDate lastLogged = LocalDate.of(Integer.parseInt(lastLoggedStr[2]), Integer.parseInt(lastLoggedStr[1]), Integer.parseInt(lastLoggedStr[0]));
